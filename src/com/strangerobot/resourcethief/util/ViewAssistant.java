...
public class ViewAssistant {
	...
	public ViewAssistant setText(int textViewId, CharSequence text, BufferType bufferType){
		findTextView(textViewId).setText(text, bufferType);
		return this;
	}
	
	
	public ViewAssistant setText(int textViewId, CharSequence text){
		return setText(textViewId, text, BufferType.NORMAL);
	}
	
	public ViewAssistant setText(int textViewId, int textResId){
		findTextView(textViewId).setText(textResId);
		return this;
	}
